...
class qa_html_theme extends qa_html_theme_base
{
    ...
    {
        $this->output('<meta name="viewport" content="width=device-width, initial-scale=1,maximum-scale=1.0,user-scalable=no"/>');
        parent::head_metas();
    }
...
EOT;
    ...
    {
        $this->output('<div id="footer_box"></div><div id="footer">');
    ...
    public function attribution()
    {
        ...
        $this->output(
            ...
            'snow_ext Theme by <a href="http://qa.yy7621.com">吴俊圆</a>',
            '</div>'
        );
        parent::attribution();
    }
